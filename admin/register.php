...
<head>
  ...
  <style>
    body {
      ...
      background: linear-gradient(rgba(158, 227, 240, 0.5), rgba(254, 237, 185, 0.9));
      min-height: 100vh;
      display: flex;
      align-items: center;
...
<body>
  ...
  <div class="login-card">
      ...
      <form action="core/handleForms.php" method="POST">
          ...
          <button type="submit" name="insertNewUserBtn" class="btn btn-custom mt-3">Register</button>
      </form>
